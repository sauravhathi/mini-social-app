  ...
  return (
    <div className="flex justify-center items-center h-screen ">
      <div className="bg-gray-200 h-1/3 px-10 rounded-xl flex flex-col justify-center items-start relative">
        <div className="border-b-2 border-gray-300 pb-4 mb-4 flex items-center gap-5 text-3xl" onClick={() => dispatch(setActiveScreen('createPost'))}>
          <BsPlusSquare className="cursor-pointer" />
          <span className="text-2xl">Create a Post</span>
        </div>
        <div className="flex items-center gap-5 text-3xl">
          <BsFilePlus className="cursor-pointer" />
